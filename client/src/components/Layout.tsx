  ...
  return (
    <div className="min-h-screen">
      ...
      <main className="lg:pl-64 min-h-screen flex flex-col">
        {/* Topbar */}
        <header className="sticky top-0 z-30 bg-white/80 backdrop-blur-md border-b border-paper-3 h-14 sm:h-16 flex items-center justify-between px-5 sm:px-7 lg:px-9">
          <div className="text-lg sm:text-xl font-extrabold tracking-tight pl-12 lg:pl-0">{title}</div>
        </header>
